...
export default function InsightCard({ title, body }) {
  return (
    <article
      className='group rounded-2xl border border-border bg-card p-4 shadow-soft transition duration-200 hover:-translate-y-0.5 hover:shadow-lg fancy-card floating-card interactive'

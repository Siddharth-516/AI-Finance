...
export default function MetricCard({ title, value, subtitle, trend = '+0%', tone = 'accent' }) {
  ...
  return (
    <article className='glass-card group rounded-2xl border border-border/80 p-4 transition duration-300 hover:-translate-y-1 hover:shadow-neon floating-card interactive'>
